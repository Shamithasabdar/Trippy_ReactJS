    ...
    return(
        <div className="trip">
            ...
            <div className="tripcard">
                ...
                text="Indonesia, officially the Republic of Indonesia, is a country in Southern Asia and Oceania
                ...
                text="Malaysia is a Southeast Asian country occupying parts of the Malay Peninsula 
                and the island of Borneo. It's known for its beaches, rainforests and mix of Malay, 
                ...
                text="France, in Western Europe, encompasses medieval cities, alpine villages and
